...
use App\Http\Livewire\Admin\Orders\PrintInvoice\OfficeInvoice;
/* login */
...
Route::group(['prefix' => 'admin','middleware' => ['store','installed']], function () {
    ...
    Route::get('print-recipt/{id}', \App\Http\Livewire\Admin\Orders\PrintInvoice\OfficeInvoice::class);
    });
