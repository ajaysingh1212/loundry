                ...
                <div class="card-body p-4">
                    ...
                    <div class="row">
                        ...
                        <div class="col-12 mt-3">
                            <a href="{{ url('admin/orders/print-recipt/' . $order->id) }}" target="_blank"
                                type="button" class="btn btn-icon btn-ouline-primary mb-0 w-100">
                                {{ $lang->data['print_invoice'] ?? 'Office Use' }}
                            </a>
