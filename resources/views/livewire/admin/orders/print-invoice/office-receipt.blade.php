...
<head>
    ...
    <title>Laundry Receipts</title>
    <link rel="stylesheet" href="{{ asset('css/receipts.css') }}">
    <script src="{{ asset('js/receipts.js') }}" defer></script>
</head>
<body>
...
.receipt-header, .receipt-connection-details, .receipt-billing-details, .receipt-consumption-details, .receipt-charges {
    margin-bottom: 20px;
    padding: 10px;
...
.receipt-account-details, .receipt-personal-details {
    width: 48%;
}
    ...
    const customers = [
        {
            ...
            accountId: '1001',
            billingCode: '961',
            nameAddress: 'Customer 1, 123 Main St, City',
            clothCount: 5,
            fixedCharges: '10.00',
        ...
        },
        {
            ...
            accountId: '1002',
            billingCode: '962',
            nameAddress: 'Customer 2, 456 Elm St, City',
            clothCount: 3,
            fixedCharges: '10.00',
        ...
        },
        {
            ...
            accountId: '1003',
            billingCode: '963',
            nameAddress: 'Customer 3, 789 Oak St, City',
            clothCount: 7,
            fixedCharges: '10.00',
            serviceCharges: '35.00',
            additionalCharges: '3.50',
            totalAmount: '48.50'
        },
        {
            rrNo: '004',
            accountId: '1004',
            billingCode: '964',
            nameAddress: 'Customer 4, 101 Pine St, City',
            clothCount: 2,
            fixedCharges: '10.00',
    ...
    customers.forEach(customer => {
        ...
        receipt.innerHTML = `
            ...
            <div class="receipt-header">
                <div class="receipt-account-details">
                    <p>Account Details:</p>
                    <p>RR No: <span>${customer.rrNo}</span></p>
                    <p>Account ID: <span>${customer.accountId}</span></p>
                    <p>Billing Code: <span>${customer.billingCode}</span></p>
                </div>
                <div class="receipt-personal-details">
                    <p>Personal Details:</p>
                    <p>Name and Address: <span>${customer.nameAddress}</span></p>
                </div>
            </div>
            <div class="receipt-connection-details">
                <p>Cloth Count: <span>${customer.clothCount}</span></p>
            </div>
            <div class="receipt-charges">
                <p>Fixed Charges: <span>${customer.fixedCharges}</span></p>
                <p>Service Charges: <span>${customer.serviceCharges}</span></p>
                <p>Additional Charges: <span>${customer.additionalCharges}</span></p>
                <p>Total Amount: <span>${customer.totalAmount}</span></p>
            </div>
        `;
...
{{-- <div>
    ...
    @if ($printer_type == 1)
        ...
        <head>
            ...
            <title>{{$lang->data['print_invoice'] ?? 'office use'}}</title>
